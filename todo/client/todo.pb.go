...
func (*Todo) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{0}
}
...
func (*CreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{1}
}
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{2}
}
...
func (*CreateBulkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{3}
}
...
func (*CreateBulkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{4}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{5}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{6}
}
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{7}
}
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{8}
}
...
func (*DeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{9}
}
...
func (*DeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{10}
}
...
func (*UpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{11}
}
...
func (*UpdateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{12}
}
...
func (*UpdateBulkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{13}
}
...
func (*UpdateBulkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_1b019519d7ed948c, []int{14}
}
...
func init() {
	...
	proto.RegisterType((*CreateRequest)(nil), "todo.client.v1.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "todo.client.v1.CreateResponse")
	proto.RegisterType((*CreateBulkRequest)(nil), "todo.client.v1.CreateBulkRequest")
	proto.RegisterType((*CreateBulkResponse)(nil), "todo.client.v1.CreateBulkResponse")
	proto.RegisterType((*GetRequest)(nil), "todo.client.v1.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "todo.client.v1.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "todo.client.v1.ListRequest")
	proto.RegisterType((*ListResponse)(nil), "todo.client.v1.ListResponse")
	proto.RegisterType((*DeleteRequest)(nil), "todo.client.v1.DeleteRequest")
	proto.RegisterType((*DeleteResponse)(nil), "todo.client.v1.DeleteResponse")
	proto.RegisterType((*UpdateRequest)(nil), "todo.client.v1.UpdateRequest")
	proto.RegisterType((*UpdateResponse)(nil), "todo.client.v1.UpdateResponse")
	proto.RegisterType((*UpdateBulkRequest)(nil), "todo.client.v1.UpdateBulkRequest")
	proto.RegisterType((*UpdateBulkResponse)(nil), "todo.client.v1.UpdateBulkResponse")
}
...
func (c *todoServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) CreateBulk(ctx context.Context, in *CreateBulkRequest, opts ...grpc.CallOption) (*CreateBulkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/CreateBulk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) UpdateBulk(ctx context.Context, in *UpdateBulkRequest, opts ...grpc.CallOption) (*UpdateBulkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.client.v1.TodoService/UpdateBulk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/Create",
	}
...
func _TodoService_CreateBulk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/CreateBulk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_UpdateBulk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.client.v1.TodoService/UpdateBulk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func init() { proto.RegisterFile("todo.proto", fileDescriptor_todo_1b019519d7ed948c) }

var fileDescriptor_todo_1b019519d7ed948c = []byte{
	// 616 bytes of a gzipped FileDescriptorProto
	,
}
