...
func (*Todo) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{0}
}
...
func (*CreateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{1}
}
...
func (*CreateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{2}
}
...
func (*CreateBulkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{3}
}
...
func (*CreateBulkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{4}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{5}
}
...
func (*GetResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{6}
}
...
func (*ListRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{7}
}
...
func (*ListResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{8}
}
...
func (*DeleteRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{9}
}
...
func (*DeleteResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{10}
}
...
func (*UpdateRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{11}
}
...
func (*UpdateResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{12}
}
...
func (*UpdateBulkRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{13}
}
...
func (*UpdateBulkResponse) Descriptor() ([]byte, []int) {
	return fileDescriptor_todo_ec854a668134922b, []int{14}
}
...
func init() {
	proto.RegisterType((*Todo)(nil), "todo.sdk.v1.Todo")
	proto.RegisterType((*CreateRequest)(nil), "todo.sdk.v1.CreateRequest")
	proto.RegisterType((*CreateResponse)(nil), "todo.sdk.v1.CreateResponse")
	proto.RegisterType((*CreateBulkRequest)(nil), "todo.sdk.v1.CreateBulkRequest")
	proto.RegisterType((*CreateBulkResponse)(nil), "todo.sdk.v1.CreateBulkResponse")
	proto.RegisterType((*GetRequest)(nil), "todo.sdk.v1.GetRequest")
	proto.RegisterType((*GetResponse)(nil), "todo.sdk.v1.GetResponse")
	proto.RegisterType((*ListRequest)(nil), "todo.sdk.v1.ListRequest")
	proto.RegisterType((*ListResponse)(nil), "todo.sdk.v1.ListResponse")
	proto.RegisterType((*DeleteRequest)(nil), "todo.sdk.v1.DeleteRequest")
	proto.RegisterType((*DeleteResponse)(nil), "todo.sdk.v1.DeleteResponse")
	proto.RegisterType((*UpdateRequest)(nil), "todo.sdk.v1.UpdateRequest")
	proto.RegisterType((*UpdateResponse)(nil), "todo.sdk.v1.UpdateResponse")
	proto.RegisterType((*UpdateBulkRequest)(nil), "todo.sdk.v1.UpdateBulkRequest")
	proto.RegisterType((*UpdateBulkResponse)(nil), "todo.sdk.v1.UpdateBulkResponse")
}
...
func (c *todoServiceClient) Create(ctx context.Context, in *CreateRequest, opts ...grpc.CallOption) (*CreateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/Create", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) CreateBulk(ctx context.Context, in *CreateBulkRequest, opts ...grpc.CallOption) (*CreateBulkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/CreateBulk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Get(ctx context.Context, in *GetRequest, opts ...grpc.CallOption) (*GetResponse, error) {
	out := new(GetResponse)
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/Get", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) List(ctx context.Context, in *ListRequest, opts ...grpc.CallOption) (*ListResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/List", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Delete(ctx context.Context, in *DeleteRequest, opts ...grpc.CallOption) (*DeleteResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/Delete", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) Update(ctx context.Context, in *UpdateRequest, opts ...grpc.CallOption) (*UpdateResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/Update", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *todoServiceClient) UpdateBulk(ctx context.Context, in *UpdateBulkRequest, opts ...grpc.CallOption) (*UpdateBulkResponse, error) {
	...
	err := c.cc.Invoke(ctx, "/todo.sdk.v1.TodoService/UpdateBulk", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func _TodoService_Create_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/Create",
	}
...
func _TodoService_CreateBulk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/CreateBulk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Get_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/Get",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_List_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/List",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Delete_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/Delete",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_Update_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/Update",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _TodoService_UpdateBulk_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/todo.sdk.v1.TodoService/UpdateBulk",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
var _TodoService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "todo.sdk.v1.TodoService",
...
func init() { proto.RegisterFile("todo.proto", fileDescriptor_todo_ec854a668134922b) }

var fileDescriptor_todo_ec854a668134922b = []byte{
	// 617 bytes of a gzipped FileDescriptorProto
	0x1f, 0x8b, 0x08, 0x00, 0x00, 0x00, 0x00, 0x00, 0x02, 0xff, 0x9c, 0x54, 0xcd, 0x6e, 0xd3, 0x4c,
	0x14, 0x95, 0x93, 0x38, 0x6a, 0xae, 0x9b, 0x7c, 0xc9, 0x28, 0x1f, 0x18, 0x13, 0x11, 0xcb, 0x08,
	0x88, 0xba, 0xb0, 0xd5, 0x80, 0x40, 0x54, 0xdd, 0xb4, 0x45, 0x2a, 0x0b, 0x10, 0x92, 0x29, 0x12,
	...
	,
}
